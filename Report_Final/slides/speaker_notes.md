...
🔗 **Chuyển tiếp:** Quay sang và nhường lời thuyết trình cho bạn Trịnh Sơn Lam.
...
> "Cảm ơn phần trình bày demo của bạn Gia An. Em là Sơn Lam, sau đây xin tiếp tục phần tài liệu tham khảo chính.
...
### Slide 36: Cảm ơn và Q&A (open) — Người trình bày: Lam
...
### Slide 38: Backup: Keyword Search (BM25) — Ví dụ tính điểm step-by-step — Người trình bày: Lam
...
### Slide 39: Backup: Kiến trúc Dual-Index — Chi tiết — Người trình bày: Lam
