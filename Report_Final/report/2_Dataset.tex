...
\begin{itemize}
    ...
    \item \textbf{Tập con sử dụng:} Toàn bộ 1,203,108 bài báo thuộc lĩnh vực Computer Science (\texttt{cs.*}).
\end{itemize}
...
\begin{enumerate}
    ...
    \item \textbf{Xuất file:} Lưu kết quả dưới dạng JSONL chuẩn để phục vụ cho bước Sinh Vector Nhúng (Embedding) và Bulk Indexing tiếp theo.
\end{enumerate}