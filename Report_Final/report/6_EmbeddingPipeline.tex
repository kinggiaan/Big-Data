...
Để giải quyết vấn đề này, chúng tôi thiết kế thuật toán \textbf{Cắt Abstract Thông minh (Smart Abstract Truncation)} trước khi thực hiện nhúng:
\begin{algorithm}[H]
\DontPrintSemicolon
...
Kết quả của giai đoạn này là tệp tin \texttt{arxiv\_cs\_full\_with\_vectors.jsonl} có dung lượng khoảng \textbf{5.4 GB}, sẵn sàng cho quá trình đánh chỉ mục tại Elasticsearch cục bộ.
